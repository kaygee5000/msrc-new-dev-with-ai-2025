// src/app/api/school-report/community-involvement/community-involvement/route.js
...
export async function GET(request) {
    ...
    const tableName = 'school_community_involvements';
...
export async function DELETE(request) {
    ...
    const tableName = 'community_involvements';
