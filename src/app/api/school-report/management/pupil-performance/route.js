// src/app/api/school-report/management/pupil-performance/route.js
import { NextResponse } from 'next/server';
import db from '@/utils/db'; // Relative path from pupil-performance/route.js to src/utils/db.js
...
export async function GET(request) {
    ...
    const tableName = 'students_performances';
