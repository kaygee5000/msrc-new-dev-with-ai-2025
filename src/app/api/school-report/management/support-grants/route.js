// src/app/api/school-report/management/support-grants/route.js
import { NextResponse } from 'next/server';
import db from '@/utils/db'; // Relative path from support-grants/route.js to src/utils/db.js
...
export async function GET(request) {
    ...
    const tableName = 'support_and_grants';
