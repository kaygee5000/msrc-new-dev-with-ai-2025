...
const MEASURE_ITEMS = {
  ...
  'Urinal': { icon: <WcIcon />, defaultStatus: 'Not Available' }, // Assuming WcIcon can be reused or a more specific one added
  'Water': {
    icon: <WaterDropIcon />,
    ...
    statuses: {
      ...
      'Stream': { label: 'Stream', color: 'warning', isAvailable: true }, // Or 'error' if stream water is generally unsafe
