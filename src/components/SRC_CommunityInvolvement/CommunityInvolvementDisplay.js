...
// Re-using the DataDisplayTable component structure (can be moved to a shared file later if needed)
...
export default function CommunityInvolvementDisplay({ filterParams }) {
